...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
			...
			$post_id = $db->createPost($title, $description, $user_id, $uploadPath);
        } else {
						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="post" action="" name="contactForm" class="contactForm" enctype="multipart/form-data">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-12">
												...
												<!-- <input type="submit" value="Publish" class="btn btn-dark"> -->
													<input class="btn btn-dark" type="submit" name="Publish" value="Publish">
